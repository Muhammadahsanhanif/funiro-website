...
function CartPage() {
      ...
      <div className="relative text-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-black">
            ...
            <span className="text-lg mb-2">Home &gt; Cart</span>
          </div>
        </div>
      </div>
  ...
  <div className="w-full md:w-1/3"> {/* Increased margin-top here */}
    <div
      ...
      className="h-80 p-4 rounded-lg shadow-lg flex flex-col items-center justify-center"
    >
      ...
      <Link to={"/Checkout"}>
        <button
          style={{ backgroundColor: "#f9f1e7" }}
          className="text-black py-2 px-4 rounded-xl mt-4 hover:bg-green-600 transition-colors border border-black"
        >
          Checkout
        </button>
      </Link>
